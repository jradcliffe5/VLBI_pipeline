...
'/bin/cp' '-r' 'VLBA_SRC'$src'.ms.tar.gz' '/users/jradcliffe5/idia/VLBA_GOODSN/targets/phase_referenced/UV/'
'/bin/cp' '-r' 'VLBA_SRC'$src'.ms.flagversions.tar.gz' '/users/jradcliffe5/idia/VLBA_GOODSN/targets/phase_referenced/UV/'
