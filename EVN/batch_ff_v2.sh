...
/data/exp_soft/pipelines/casa-prerelease-5.3.0-115.el7/bin/mpicasa /usr/bin/singularity\
 exec /data/exp_soft/containers/casa-stable-5.5.0-149.simg\
   "casa" --nologger --log2term --nogui -c fringe_fit_part1.py $inbase $phasecal $sbdcal
...
#/data/exp_soft/pipelines/casa-prerelease-5.3.0-115.el7/bin/mpicasa /usr/bin/singularity\
# exec /data/exp_soft/containers/casa-stable-5.5.0-149.simg\
   #"casa" --nologger --log2term --nogui -c fringe_fit_part2.py $inbase $phasecal $sbdcal $casa_tclean 1

#for W_LOOP in 2 3
#do
#	rm -r $epoch"/ff_im_cycle_"$W_LOOP"-0*"
#	/data/exp_soft/pipelines/casa-prerelease-5.3.0-115.el7/bin/mpicasa /usr/bin/singularity exec /data/exp_soft/containers/casa-stable-5.5.0-149.simg "casa" --nologger --log2term --nogui -c fringe_fit_part2.py $inbase $phasecal $sbdcal $casa_tclean $W_LOOP
#done